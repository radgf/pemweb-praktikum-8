        ...
        <div class="container">
            <div class="card mt-3 mb-3">
                <div class="card-header text-center fw-bold">FORMULIR PESERTA DIDIK</div>
                    ...
                    <div class="card-body">
                        <form method="post" action="actiondataayah.php">

                        <div class="form-group row">
                            <label for="namaayah" class="col-sm-2 col-form-label">Nama Ayah Kandung</label>
                            <div class="col-sm-10">
                                <input type="text" name="namaayah" id="namaayah" class="form-control <?php echo 
                                ($error_namaayah !="" ? "is-invalid" : ""); ?>" placeholder="Nama Lengkap" value="<?php echo 
                                $namaayah; ?>"> <span class="warning"><?php echo $error_namaayah ?></span>
                            </div>
                        </div><br>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="tlayah" id="tlayah" class="form-control <?php echo 
                                ($error_tlayah !="" ? "is-invalid" : ""); ?>" placeholder="19xx" value="<?php echo 
                                $tlayah; ?>"> <span class="warning"><?php echo $error_tlayah ?></span>
                            </div>
                        </div><br>
                        ...
                        <div class="form-group row">
                            <label for="kerjaayah" class="col-sm-2 col-form-label ">Pekerjaan</label>
                            <div class="col-sm-10">
                                <select class="col-sm-2 form-select" name="kerjaayah">
                                <option value=""></option>
                                ...
                                <span class="warning" ><?php echo $error_kerjaayah; ?></span>
                            </div>
                        </div><br>
