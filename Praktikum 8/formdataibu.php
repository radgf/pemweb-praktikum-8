        ...
        <div class="container">
            <div class="card mt-3 mb-3">
                <div class="card-header text-center fw-bold">FORMULIR PESERTA DIDIK</div>
                    ...
                    <div class="card-body">
                        <form method="post" action="actiondataibu.php">

                        <div class="form-group row">
                            <label for="namaibu" class="col-sm-2 col-form-label">Nama Ibu Kandung</label>
                            <div class="col-sm-10">
                                <input type="text" name="namaibu" id="namaibu" class="form-control <?php echo 
                                ($error_namaibu !="" ? "is-invalid" : ""); ?>" placeholder="Nama Lengkap" value="<?php echo 
                                $namaibu; ?>"> <span class="warning"><?php echo $error_namaibu ?></span>
                            </div>
                        </div><br>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="tlibu" id="tlibu" class="form-control <?php echo 
                                ($error_tlibu !="" ? "is-invalid" : ""); ?>" placeholder="19xx" value="<?php echo 
                                $tlibu; ?>"> <span class="warning"><?php echo $error_tlibu ?></span>
                            </div>
                        </div><br>
